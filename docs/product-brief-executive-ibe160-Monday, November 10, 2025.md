...
*   **Goals:** To discover and evaluate potential study programs, including understanding options for extra courses, specializations, and program expansions.
*   **Pain Points:** They experience significant frustration due to the website's poor organization and complex navigation, which can lead them to abandon their research and consider other universities.

#### Primary User Segment 2: Current Students

*   **Profile:** Enrolled students from all years of study who are actively managing their academic journey.
*   **Goals:** To find accurate information about available courses and their prerequisites to plan their semesters and ensure they meet degree requirements.
*   **Pain Points:** They are hindered by poor search functionality and complex navigation on the website, and find that academic advisors are often overwhelmed with basic questions.
...
*   **Basic Q&A for Study Programs:** Provide quick, direct, and accurate answers to common questions about university study programs.
*   **Suggesting Study Paths & Program Combinations:** Guide students in exploring long-term study options and program combinations.
*   **Information Sourcing & Referencing:** All answers must include links to "more information" and cite the source URL(s).
*   **Interactive Guidance:** Proactively ask clarifying questions to guide users towards the correct information.
*   **Information Synthesis:** Combine and summarize relevant information from multiple pages to provide comprehensive answers.
*   **One-Click Access & Escalation:** Easily accessible from the university website, with a direct link to the contact page if the chatbot cannot answer.
*   **User Satisfaction Feedback:** Implement a 1-10 satisfaction scale at the end of each conversation.

#### Out of Scope for MVP

*   Email Conversation Log
*   Forward Log on Escalation
*   Multilingual Support
*   Daily Automated Website Scraping

---

## 5. Financial Impact & Strategic Alignment

#### Financial Impact

The project will be developed exclusively using free-tier services for all technologies. This ensures that the development and initial deployment of the chatbot will incur no direct financial cost. The primary investment will be the development time and effort within the 3-week project timeline.
